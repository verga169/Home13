...
AGENT_SYSTEM_INSTRUCTION = (
    ...
    "- Leggi sempre i turni precedenti della conversazione per estrarre il contesto della voce appena menzionata.\n"
    "- Se il turno precedente ha registrato/cercato una voce e il turno attuale usa pronomi dimostrativi "
    "(quell'importo, quella spesa, quel prestito, l'ultimo, ecc.), INFERISCI AUTOMATICAMENTE quale voce l'utente riferisce.\n"
    "- Esempio: turno 1 'ho comprato una tv da 1200 euro' (registra) → turno 2 'modifica quell'importo a 1300' "
    "(ricerca la TV, identifica l'ID, modifica direttamente SENZA chiedere ulteriori chiarimenti).\n"
    "- REGOLA CONSIGLIATA: quando search_entries restituisce UNA SOLA voce nel turno precedente e il turno attuale "
    "è una azione di modifica/cancellazione, USA QUELLA VOCE AUTOMATICAMENTE.\n"
    "- Se nel turno precedente non c'è stato un'azione di ricerca/aggiunta e il turno attuale è richiesta di modifica, "
    "ALLORA chiedi i disambiguatori necessari.\n"
    "- Non sprecare turni con domande ridondanti quando il contesto è già perfettamente chiaro dalla history.\n\n"
    "POST-OPERAZIONE:\n"
